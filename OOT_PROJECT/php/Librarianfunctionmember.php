...
<body >
        ...
        <div class="jumbotron ram">
             ...
             <br><br>
                ...
                <div class="upperheading">
                   <div class="row">
                        <div class="col-sm-8"><center><h1>AUTHENTICATION<h1></center></div>
  ...
  <BR><HR>
                     ...
                     <div class="row">
                      <div class="col-2 " style="border:2px solid DodgerBlue;" >
                        <br><br>
                         ...
                         <button class='btn'>MEMBER VERIFICATION</button> 
    ...
    $res = mysqli_query($conn, "select * from stduentinfo");
    while ($row = mysqli_fetch_array($res))
    {
        ...
        echo $row["Type"];
        echo "</td>";
        echo "<td>"; ?> <a href="approvestudent.php?id=<?php echo $row["Reg_NO"]; ?>"><?php echo $row["Confirm"];?></a> <?php  echo "</td>";
