...
<body >
  ...
  <BR><HR>
                ...
                <div class="entries">
                   ...
                   <div class="row">
                             ...
                             <div class="col wid"  style="border:2px solid DodgerBlue;">
                                  ...
                                  <input type="text" class="bru" name="USERID" placeholder="USERID">
                      ...
                      <div class="col-2 " style="border:2px solid DodgerBlue;" >
                        <br><br>
                         ...
                         <button class='btn'  onclick="location.href = 'Librarianfunctionreturn.php';">  RETURN BOOK</button> 
                          ...
                          <button class='btn' >Search Member</button> 
                      </div>
    ...
    $res = mysqli_query($conn, "select * from issuebook where STATUS='YES'");
